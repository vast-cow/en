...
[https://portal.office.com/account?ServiceID=LanguageItem#installs](https://portal.office.com/account?ServiceID=LanguageItem#installs)

1. View the list of installed devices
2. Select the target PC
3. Click **[Sign out]**
...
4. Select **Microsoft 365 Apps** (or Microsoft Office)
5. Click **Uninstall**
...
* To properly reduce the device count, follow this order:
  **① Deactivate the device via the web → ② Uninstall Office from the PC**
