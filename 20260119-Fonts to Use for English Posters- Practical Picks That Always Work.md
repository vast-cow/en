...
**Why this works:**
Research posters typically contain more text and figures. A clean sans-serif body font stays readable at distance and at awkward viewing angles, which is exactly how people read posters in real venues.
...
**Why this works:**
You can inject personality through the headline while keeping the body neutral and comfortable to read. This balance prevents the poster from feeling “designed” at the expense of clarity.
...
**Important caution:**
Serif fonts can look sophisticated, but **serif body text often breaks down on posters**—thin strokes can fill in or vanish depending on printing and viewing distance. A common safe approach is **serif for the headline only**, sans-serif for everything else.
...
* **Body:** Regular to Medium
  Thin weights may look sleek on screen but often fail in real print settings.

### Pay attention to numbers

Posters usually include:

* dates, measurements, p-values, percentages, axes, and legends
  Fonts like **Inter** and **Roboto** handle numerals well. If available, consider enabling **tabular figures** (monospaced numerals) for charts and tables so columns align cleanly.
...
* Illustrator/InDesign workflows often allow more flexibility
  For final output, many teams **embed fonts** or **convert text to outlines** to prevent font substitution.
